...
def add_default_fields_layout(force=False):
	...
	sidebar_fields_layouts = {
		...
		"Design-Side Panel": {
			"doctype": "Design",
			"layout": '[{"label":"Design Information","name":"design_information","opened":true,"columns":[{"name":"column1","fields":["design_template","status","item"]}],"showEditButton":true,"visible":3},{"label":"Cost Details","name":"price_list","opened":true,"columns":[{"name":"column1","fields":["direct_material_cost","operating_cost","total_cost"]}],"showEditButton":false,"visible":3,"editingLabel":false},{"label":"Ownership","name":"ownership_tab","opened":true,"columns":[{"name":"column1","fields":["created_by"]}],"showEditButton":false,"visible":1}]',
		},
		"Item-Side Panel": {
			"doctype": "Item",
